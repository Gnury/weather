...
class ResponseForecastWeather {
  ...
  factory ResponseForecastWeather.fromRawJson(String str) => ResponseForecastWeather.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ResponseForecastWeather.fromJson(Map<String, dynamic> json) => ResponseForecastWeather(
    cod: json["cod"],
